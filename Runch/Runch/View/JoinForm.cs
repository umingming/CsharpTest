...
namespace Runch.View
{
    ...
    public partial class JoinForm : Form
    {
        ...
        private void InitCmb(object sender, EventArgs e)
        {
            ...
            var groups = new[] {
                new { Text = " F/W그룹", Value = "1" },
                new { Text = " ITO그룹", Value = "2" },
                new { Text = " QA그룹", Value = "3" },
                new { Text = " WEB/UX그룹", Value = "4" },
                new { Text = " 개발1그룹", Value = "5" },
                new { Text = " 개발2그룹", Value = "6" },
                new { Text = " 공항그룹", Value = "7" },
                new { Text = " 국내영업1그룹", Value = "8" },
                new { Text = " 국내영업2그룹", Value = "9" },
                new { Text = " 물류솔루션1그룹", Value = "10" },
                new { Text = " 물류솔루션2그룹", Value = "11" },
                new { Text = " 솔루션1그룹", Value = "12" },
                new { Text = " 솔루션2그룹", Value = "13" },
                new { Text = " 솔루션3그룹", Value = "14" },
                new { Text = " 영업관리&지원그룹", Value = "15" },
                new { Text = " 운영그룹", Value = "16" },
                new { Text = " 인사그룹", Value = "17" },
                new { Text = " 자동화1그룹", Value = "18" },
                new { Text = " 자동화2그룹", Value = "19" },
                new { Text = " 자동화3그룹", Value = "20" },
                new { Text = " 자동화4그룹", Value = "21" },
                new { Text = " 재무그룹", Value = "22" },
                new { Text = " 제조솔루션1그룹", Value = "23" },
                new { Text = " 제조솔루션2그룹", Value = "24" },
                new { Text = " 중국영업1그룹", Value = "25" },
                new { Text = " 중국영업2그룹", Value = "26" },
            ...
            var positions = new[] {
                ...
                new { Text = " 수석보", Value = "31" },
                new { Text = " 수석", Value = "32" },
                new { Text = " 이사", Value = "33" },
                new { Text = " 상무", Value = "34" },
                new { Text = " 전무", Value = "35" },
                new { Text = " 부사장", Value = "36" },
